...
bot.on('ready', () => {
    voice_channel = bot.channels.get("275157297318068225")
    text_channel = bot.channels.get("275880097460781057");
})
exports.play = function (URL, message) {
    member = message.member;
    if (message.channel != text_channel) {
        return message.reply("Please issue this command in #music-lobby");
    }
